...
public class DownloadDocumentsOfAgreement {
  ...
  // Agreement documents file name
  private static final String agreementDocs = "agreementDocs";
  ...
  private void run() throws Exception {
    ...
    for (Object eachDocument : documentList) {
      ...
      // these possibilities.
      String fileName = documentName + "_" + agreementDocs + "_" + System.currentTimeMillis() + ".pdf";
