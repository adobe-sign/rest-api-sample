...
public class SendReminderOnPendingAgreements {
  ...
  private JSONArray getNextParticipantInfos(String accessToken, String agreementId) throws Exception {
    ...
    return (JSONArray) agreementInfo.get("nextParticipantSetInfos");
  }
  ...
  private boolean hasWaitingTimeExceededLimit(JSONObject participant, Date now) {
    ...
    JSONArray nextParticipantSetMemberInfosArr = ((JSONArray)participant.get("nextParticipantSetMemberInfos"));
    JSONObject nextParticipantSetMemberInfo = (JSONObject) nextParticipantSetMemberInfosArr.get(0);
    String waitingSinceStr = (String) nextParticipantSetMemberInfo.get("waitingSince");
