 ...
 * 
 * <p>
 * <b>IMPORTANT</b>: Before running this sample, check that you have modified the JSON files 'OAuthCredentials.json' and 'CreateWidget.json' with
...
public class CreateNewWidgetWithCounerSigners {
  ...
  private void run() throws Exception {
    ...
    JSONObject widget = RestApiWidgets.createWidget(accessToken, createWidgetJSONFileName, transientDocumentId, idName, formFieldDocumentId, formFieldIdName);
